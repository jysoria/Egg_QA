...
SubProceso Menu(vectorA, vectorB, vectorC, n)
	...
	Definir i Como Entero
	Definir inicializadoA, inicializadoB, inicializadoC Como Logico
	inicializadoA = Falso
	inicializadoB = Falso
	inicializadoC = Falso
	...
	Hacer
		...
		Segun opcionMenu Hacer
			"A": 
				...
				FinPara
				inicializadoA = Verdadero
			"B": 
				Para i <- 0 Hasta n-1 Con Paso 1 Hacer
					vectorB(i) = Aleatorio(-100, 100)
				FinPara
				inicializadoB = Verdadero
			"C": 
				Para i <- 0 Hasta n-1 Con Paso 1 Hacer
					vectorC(i) = vectorA(i) + vectorB(i)
				FinPara
				inicializadoC = Verdadero
			"D":
				Para i <- 0 Hasta n-1 Con Paso 1 Hacer
			...
			"E":
				...
				Segun opcionVector Hacer
					"A": 
						Si inicializadoA = Verdadero Entonces
							MostrarVector(vectorA, n)
						SiNo
							Escribir "Vector no inicializado, inicialice en la opcion A"
						FinSi
					"B":
						Si inicializadoB = Verdadero Entonces
							MostrarVector(vectorB, n)
						SiNo
							Escribir "Vector no inicializado, inicialice en la opcion B"
						FinSi
					"C":
						Si inicializadoC = Verdadero Entonces
							MostrarVector(vectorC, n)
						SiNo
							Escribir "Vector no inicializado, inicialice en la opcion C o D"
						FinSi
				FinSegun
			"F":
				Escribir "Chau."
